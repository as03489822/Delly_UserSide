...
export const AppBanner = () => {
    let infoArr = [['75,000+','Deals'],['6,000+','Retailers'],['2 Million','Active Users'],['1.3 Million','App Downloads']]
  return (
    <>
    {/* mobil app banner */}
    <div className="px-4  flex w-full justify-center bg-white  md:py-20 rounded-lg ">
        <div className=" mx-4 mt-10 pt-10 md:pt-0  h-[700px] md:h-[600px] border bordre-solid flex flex-col md:flex-row items-center justify-center w-[1200px] h-[550px] bg-[#F0FFF8] rounded-xl ">
            ...
            <div className='flex px-5 md:px-0 pt-16 flex-col gap-5 md:w-[50%]'>
                <h1 className="text-[34px] outfit md:text-[54px] font-semibold leading-[40px] md:leading-[60px]">Download Our App To Get Amazing<span className="text-[#219653]">Deals</span></h1>
                <p className=' text-[14px] outfit'>Get new deals every day. Top deals have the best offers and share
    ...
    <div className={`relative flex justify-center  bg-[#FCF5DC]`} >
        ...
        <div className='z-10 flex flex-col md:flex-row gap-5 md:gap-10  items-center py-20'>
            <p className='text-center  w-[70%] md:w-auto text-[24px] outfit font-600'>For inquiries and more information</p>
            <button className="outfit text-[16px] rounded-full py-3 px-5 bg-[#013D29]  text-white">Get in Touch</button>
        </div>
    </div> 
    </>
  )
